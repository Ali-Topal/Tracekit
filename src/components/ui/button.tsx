...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  ghost:
    "border border-zinc-300 bg-transparent text-zinc-900 hover:bg-zinc-50 focus-visible:outline-zinc-300 dark:border-zinc-700 dark:text-zinc-100 dark:hover:bg-zinc-800/40",
};
